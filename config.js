var config = {
    ...
    hostname: 'https://polar-temple-84344.herokuapp.com/', // https://publicshopifyapp.com
    shopify: {
     ...
     */
    web_hook: {
        uninstall: 'https://polar-temple-84344.herokuapp.com/api/v1/uninstall' //example, used ngrok "ngrok http localhost:3000"
    }
};
